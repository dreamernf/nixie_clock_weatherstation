...
typedef enum 
{
  PWM_T3_PB4_BLUE = 0,  // PWM per TIM3 an PC6
  PWM_T3_PB5_RED= 1,   // PWM per TIM3 an PB5
  PWM_T3_PB0_GREEN = 2   // PWM per TIM3 an PB5
}PWM_TIM3_NAME_t;

#define  PWM_TIM3_ANZ   3 // Anzahl von PWM_TIM3_NAME_t
