...
#ifndef TM_RE_A_PIN
#define TM_RE_A_RCC					RCC_AHB1Periph_GPIOC
#define TM_RE_A_PORT				GPIOC
#define TM_RE_A_PIN					GPIO_Pin_4
#define TM_RE_A_EXTI_LINE			EXTI_Line4
#define TM_RE_A_EXTIPINSOURCE		EXTI_PinSource4
#define TM_RE_A_EXTIPORTSOURCE		EXTI_PortSourceGPIOC
#define TM_RE_A_NVIC				EXTI4_IRQn
#define TM_RE_A_DEFAULT
#endif

/* Rotary encoder B pin */
#ifndef TM_RE_B_PIN
#define TM_RE_B_RCC					RCC_AHB1Periph_GPIOC
#define TM_RE_B_PORT				GPIOC
#define TM_RE_B_PIN					GPIO_Pin_5
#endif
