...
PWM_TIM3_t PWM_TIM3[] = {
  ...
  {PWM_T3_PB4_BLUE ,1      ,GPIOB ,GPIO_Pin_4 ,RCC_AHB1Periph_GPIOB ,GPIO_PinSource4 ,  0},
  {PWM_T3_PB5_RED ,2      ,GPIOB ,GPIO_Pin_5 ,RCC_AHB1Periph_GPIOB ,GPIO_PinSource5 ,  0},
  {PWM_T3_PB0_GREEN ,3      ,GPIOB ,GPIO_Pin_0 ,RCC_AHB1Periph_GPIOB ,GPIO_PinSource0 ,  0},
};
